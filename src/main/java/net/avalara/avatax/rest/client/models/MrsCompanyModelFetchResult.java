 ...
 * 
 */
public class MrsCompanyModelFetchResult {
    ...
    private ArrayList<MrsCompanyModel> value;
     ...
     * 
     */
    public ArrayList<MrsCompanyModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<MrsCompanyModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of MrsCompanyModelFetchResult
     */
    @Override
