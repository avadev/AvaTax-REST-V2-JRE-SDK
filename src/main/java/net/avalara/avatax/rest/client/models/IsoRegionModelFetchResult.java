 ...
 * 
 */
public class IsoRegionModelFetchResult {
    ...
    private ArrayList<IsoRegionModel> value;
     ...
     * 
     */
    public ArrayList<IsoRegionModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<IsoRegionModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of IsoRegionModelFetchResult
     */
    @Override
