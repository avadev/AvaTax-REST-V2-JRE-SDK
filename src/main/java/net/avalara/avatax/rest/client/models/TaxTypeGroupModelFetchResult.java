 ...
 * 
 */
public class TaxTypeGroupModelFetchResult {
    ...
    private ArrayList<TaxTypeGroupModel> value;
     ...
     * 
     */
    public ArrayList<TaxTypeGroupModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<TaxTypeGroupModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of TaxTypeGroupModelFetchResult
     */
    @Override
