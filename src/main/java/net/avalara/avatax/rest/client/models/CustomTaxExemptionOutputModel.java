 ...
 */
public class CustomTaxExemptionOutputModel {
     ...
     * Getter for exempt
     *
     * Whether this tax treatment sets an item as exempt or not exempt. When true, matching lines are exempt from
    * this custom tax; when false, an existing exemption is explicitly overridden so the custom tax still applies.
     */
    ...
    * this custom tax; when false, an existing exemption is explicitly overridden so the custom tax still applies.
     ...
     *
     * Optionally set the type of jurisdiction this exemption applies to, e.g. State or City. When combined with
    * `jurisCode`, the exemption is scoped to the matching jurisdiction only.
     */
    ...
    * `jurisCode`, the exemption is scoped to the matching jurisdiction only.
     ...
     *
     * Optionally set the specific jurisdiction this exemption applies to. This should be one of the jurisdictions
    * defined on the parent custom tax.
     */
    ...
    * defined on the parent custom tax.
     ...
     * Getter for taxCode
     *
     * Optionally set a specific tax code this exemption applies to. Tax codes identify product or service
    ...
    * categories for taxation.
     ...
     *
     * Optionally set a specific tariff code this exemption applies to. Tariff codes are used for cross-border and
    * customs taxation.
     */
    ...
    * customs taxation.
     ...
     *
     * Optionally set a specific entity use code this exemption applies to. Entity use codes describe customer usage
    * such as resale, manufacturing, or government use.
     */
    ...
    * such as resale, manufacturing, or government use.
     ...
     *
     * Optionally set a different effective date for this exemption. This date cannot be earlier
    ...
    * than the base effective date set for the entire custom tax.
     ...
     * Getter for endDate
     *
     * Optionally set a different expiration date for this exemption. This date cannot be later
    ...
    * than the base expiration date set for the entire custom tax.
     ...
     *
     * Whether this exemption applies to all child jurisdictions or only the specified one. When true, the exemption
    * is applied to every jurisdiction beneath the one identified by `jurisCode`; when false or null, only the exact
    ...
    * jurisdiction is matched.
    ...
    /**
     * Returns a JSON string representation of CustomTaxExemptionOutputModel
     */
    @Override
