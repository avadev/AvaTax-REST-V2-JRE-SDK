 ...
 * 
 */
public class ContactModelFetchResult {
    ...
    private ArrayList<ContactModel> value;
     ...
     * 
     */
    public ArrayList<ContactModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<ContactModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of ContactModelFetchResult
     */
    @Override
