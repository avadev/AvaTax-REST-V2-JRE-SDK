 ...
 */
public class CustomRuleComponentDefinitionModel {


    private CustomRuleComponentType type;
    ...
    * This is typically one of the following: Condition, Action, or Variable.
     */
    public CustomRuleComponentType getType() {
        return this.type;
    }
    ...
    * This is typically one of the following: Condition, Action, or Variable.
     */
    public void setType(CustomRuleComponentType value) {
        this.type = value;
    }
    ...
    * The subtype determines the expected format of the data property.
    ...
    /**
     * Returns a JSON string representation of CustomRuleComponentDefinitionModel
     */
    @Override
