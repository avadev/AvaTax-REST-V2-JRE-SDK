 ...
 */
public enum CustomRuleComponentSubtype {
    /** 
	...
	private CustomRuleComponentSubtype(int value) {
		this.value = value;
	}
	
	static {
		for (CustomRuleComponentSubtype enumName : CustomRuleComponentSubtype.values()) {
			map.put(enumName.value, enumName);
		}
	}
	
	public static CustomRuleComponentSubtype valueOf(int intValue) {
		return (CustomRuleComponentSubtype) map.get(intValue);
	}
