 ...
 * 
 */
public class UomModelFetchResult {
    ...
    private ArrayList<UomModel> value;
     ...
     * 
     */
    public ArrayList<UomModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<UomModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of UomModelFetchResult
     */
    @Override
