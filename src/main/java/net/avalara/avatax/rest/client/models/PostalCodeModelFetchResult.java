 ...
 * 
 */
public class PostalCodeModelFetchResult {
    ...
    private ArrayList<PostalCodeModel> value;
     ...
     * 
     */
    public ArrayList<PostalCodeModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<PostalCodeModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of PostalCodeModelFetchResult
     */
    @Override
