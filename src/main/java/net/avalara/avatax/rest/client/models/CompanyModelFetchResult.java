 ...
 * 
 */
public class CompanyModelFetchResult {
    ...
    private ArrayList<CompanyModel> value;
     ...
     * 
     */
    public ArrayList<CompanyModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<CompanyModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of CompanyModelFetchResult
     */
    @Override
