 ...
 * 
 */
public class SubscriptionModelFetchResult {
    ...
    private ArrayList<SubscriptionModel> value;
     ...
     * 
     */
    public ArrayList<SubscriptionModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<SubscriptionModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of SubscriptionModelFetchResult
     */
    @Override
