...
public class CustomRuleFieldLevelDefinitionModel {
    ...
    private ArrayList<CustomRuleEnumValueModel> anyOf;
     ...
     */
    public ArrayList<CustomRuleEnumValueModel> getAnyOf() {
        return this.anyOf;
    }
     ...
     * Optional list of enumerated values.
     */
    public void setAnyOf(ArrayList<CustomRuleEnumValueModel> value) {
        this.anyOf = value;
    }
    ...
    /**
     * Returns a JSON string representation of CustomRuleFieldLevelDefinitionModel
     */
    @Override
