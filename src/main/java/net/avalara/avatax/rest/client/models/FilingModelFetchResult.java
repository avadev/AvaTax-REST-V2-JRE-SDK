...
public class FilingModelFetchResult {
    ...
    private ArrayList<FilingModel> value;
     ...
     * 
     */
    public ArrayList<FilingModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<FilingModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of FilingModelFetchResult
     */
    @Override
