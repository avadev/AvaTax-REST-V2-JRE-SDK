 ...
 * 
 */
public class BatchModelFetchResult {
    ...
    private ArrayList<BatchModel> value;
     ...
     * 
     */
    public ArrayList<BatchModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<BatchModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of BatchModelFetchResult
     */
    @Override
