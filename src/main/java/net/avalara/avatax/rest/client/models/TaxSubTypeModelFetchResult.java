 ...
 * 
 */
public class TaxSubTypeModelFetchResult {
    ...
    private ArrayList<TaxSubTypeModel> value;
     ...
     * 
     */
    public ArrayList<TaxSubTypeModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<TaxSubTypeModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of TaxSubTypeModelFetchResult
     */
    @Override
