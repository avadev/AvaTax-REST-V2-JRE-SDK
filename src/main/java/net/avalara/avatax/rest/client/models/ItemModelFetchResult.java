 ...
 * 
 */
public class ItemModelFetchResult {
    ...
    private ArrayList<ItemModel> value;
     ...
     * 
     */
    public ArrayList<ItemModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<ItemModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of ItemModelFetchResult
     */
    @Override
