 ...
 * 
 */
public class EcmsModelFetchResult {
    ...
    private ArrayList<EcmsModel> value;
     ...
     * 
     */
    public ArrayList<EcmsModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<EcmsModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of EcmsModelFetchResult
     */
    @Override
