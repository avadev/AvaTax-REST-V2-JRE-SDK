 ...
 * 
 */
public class TransactionModelFetchResult {
    ...
    private ArrayList<TransactionModel> value;
     ...
     * 
     */
    public ArrayList<TransactionModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<TransactionModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of TransactionModelFetchResult
     */
    @Override
