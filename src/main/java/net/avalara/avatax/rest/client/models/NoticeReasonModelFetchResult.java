 ...
 * 
 */
public class NoticeReasonModelFetchResult {
    ...
    private ArrayList<NoticeReasonModel> value;
     ...
     * 
     */
    public ArrayList<NoticeReasonModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<NoticeReasonModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of NoticeReasonModelFetchResult
     */
    @Override
