 ...
 * 
 */
public class NoticeModelFetchResult {
    ...
    private ArrayList<NoticeModel> value;
     ...
     * 
     */
    public ArrayList<NoticeModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<NoticeModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of NoticeModelFetchResult
     */
    @Override
