 ...
 * 
 */
public class TaxCodeModelFetchResult {
    ...
    private ArrayList<TaxCodeModel> value;
     ...
     * 
     */
    public ArrayList<TaxCodeModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<TaxCodeModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of TaxCodeModelFetchResult
     */
    @Override
