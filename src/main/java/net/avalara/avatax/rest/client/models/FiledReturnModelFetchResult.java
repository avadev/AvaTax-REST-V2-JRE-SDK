 ...
 * 
 */
public class FiledReturnModelFetchResult {
    ...
    private ArrayList<FiledReturnModel> value;
     ...
     * 
     */
    public ArrayList<FiledReturnModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<FiledReturnModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of FiledReturnModelFetchResult
     */
    @Override
