 ...
 * 
 */
public class NotificationModelFetchResult {
    ...
    private ArrayList<NotificationModel> value;
     ...
     * 
     */
    public ArrayList<NotificationModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<NotificationModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of NotificationModelFetchResult
     */
    @Override
