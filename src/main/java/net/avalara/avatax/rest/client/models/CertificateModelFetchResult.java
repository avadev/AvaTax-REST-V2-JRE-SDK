 ...
 * 
 */
public class CertificateModelFetchResult {
    ...
    private ArrayList<CertificateModel> value;
     ...
     * 
     */
    public ArrayList<CertificateModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<CertificateModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of CertificateModelFetchResult
     */
    @Override
