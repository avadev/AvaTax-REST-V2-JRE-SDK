 ...
 * 
 */
public class IsoCountryModelFetchResult {
    ...
    private ArrayList<IsoCountryModel> value;
     ...
     * 
     */
    public ArrayList<IsoCountryModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<IsoCountryModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of IsoCountryModelFetchResult
     */
    @Override
