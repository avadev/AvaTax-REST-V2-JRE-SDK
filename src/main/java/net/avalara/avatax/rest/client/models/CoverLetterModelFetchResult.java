 ...
 * 
 */
public class CoverLetterModelFetchResult {
    ...
    private ArrayList<CoverLetterModel> value;
     ...
     * 
     */
    public ArrayList<CoverLetterModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<CoverLetterModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of CoverLetterModelFetchResult
     */
    @Override
