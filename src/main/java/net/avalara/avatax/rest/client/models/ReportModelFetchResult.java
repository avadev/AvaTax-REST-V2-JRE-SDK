 ...
 * 
 */
public class ReportModelFetchResult {
    ...
    private ArrayList<ReportModel> value;
     ...
     * 
     */
    public ArrayList<ReportModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<ReportModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of ReportModelFetchResult
     */
    @Override
