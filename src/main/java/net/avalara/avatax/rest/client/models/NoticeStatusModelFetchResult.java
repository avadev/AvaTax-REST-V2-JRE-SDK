 ...
 * 
 */
public class NoticeStatusModelFetchResult {
    ...
    private ArrayList<NoticeStatusModel> value;
     ...
     * 
     */
    public ArrayList<NoticeStatusModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<NoticeStatusModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of NoticeStatusModelFetchResult
     */
    @Override
