 ...
 * 
 */
public class TaxRuleModelFetchResult {
    ...
    private ArrayList<TaxRuleModel> value;
     ...
     * 
     */
    public ArrayList<TaxRuleModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<TaxRuleModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of TaxRuleModelFetchResult
     */
    @Override
