 ...
 * 
 */
public class NexusModelFetchResult {
    ...
    private ArrayList<NexusModel> value;
     ...
     * 
     */
    public ArrayList<NexusModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<NexusModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of NexusModelFetchResult
     */
    @Override
