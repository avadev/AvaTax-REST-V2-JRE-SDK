 ...
 * 
 */
public class UPCModelFetchResult {
    ...
    private ArrayList<UPCModel> value;
     ...
     * 
     */
    public ArrayList<UPCModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<UPCModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of UPCModelFetchResult
     */
    @Override
