 ...
 * 
 */
public class FormMasterModelFetchResult {
    ...
    private ArrayList<FormMasterModel> value;
     ...
     * 
     */
    public ArrayList<FormMasterModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<FormMasterModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of FormMasterModelFetchResult
     */
    @Override
