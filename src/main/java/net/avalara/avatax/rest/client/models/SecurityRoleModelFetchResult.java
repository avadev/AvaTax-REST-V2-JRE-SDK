 ...
 * 
 */
public class SecurityRoleModelFetchResult {
    ...
    private ArrayList<SecurityRoleModel> value;
     ...
     * 
     */
    public ArrayList<SecurityRoleModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<SecurityRoleModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of SecurityRoleModelFetchResult
     */
    @Override
