 ...
 * 
 */
public class AccountModelFetchResult {
    ...
    private ArrayList<AccountModel> value;
     ...
     * 
     */
    public ArrayList<AccountModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<AccountModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of AccountModelFetchResult
     */
    @Override
