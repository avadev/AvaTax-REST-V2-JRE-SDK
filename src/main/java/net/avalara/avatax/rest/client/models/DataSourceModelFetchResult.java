 ...
 * 
 */
public class DataSourceModelFetchResult {
    ...
    private ArrayList<DataSourceModel> value;
     ...
     * 
     */
    public ArrayList<DataSourceModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<DataSourceModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of DataSourceModelFetchResult
     */
    @Override
