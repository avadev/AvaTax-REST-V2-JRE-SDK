 ...
 * 
 */
public class AuditModelFetchResult {
    ...
    private ArrayList<AuditModel> value;
     ...
     * 
     */
    public ArrayList<AuditModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<AuditModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of AuditModelFetchResult
     */
    @Override
