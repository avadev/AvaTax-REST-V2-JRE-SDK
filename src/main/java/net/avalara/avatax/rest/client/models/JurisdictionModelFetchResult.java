 ...
 * 
 */
public class JurisdictionModelFetchResult {
    ...
    private ArrayList<JurisdictionModel> value;
     ...
     * 
     */
    public ArrayList<JurisdictionModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<JurisdictionModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of JurisdictionModelFetchResult
     */
    @Override
