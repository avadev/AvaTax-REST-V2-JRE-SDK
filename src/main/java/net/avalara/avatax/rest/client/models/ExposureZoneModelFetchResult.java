 ...
 * 
 */
public class ExposureZoneModelFetchResult {
    ...
    private ArrayList<ExposureZoneModel> value;
     ...
     * 
     */
    public ArrayList<ExposureZoneModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<ExposureZoneModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of ExposureZoneModelFetchResult
     */
    @Override
