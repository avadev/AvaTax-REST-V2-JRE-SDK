 ...
 * 
 */
public class TaxAuthorityModelFetchResult {
    ...
    private ArrayList<TaxAuthorityModel> value;
     ...
     * 
     */
    public ArrayList<TaxAuthorityModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<TaxAuthorityModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of TaxAuthorityModelFetchResult
     */
    @Override
