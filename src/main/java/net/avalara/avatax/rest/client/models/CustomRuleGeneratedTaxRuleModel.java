 ...
 */
public class CustomRuleGeneratedTaxRuleModel {
    ...
    *  
    * * In the United States, this value can be used for rules written at the `State` jurisdictional level. If set to `true`, this rule will apply at the state level, county level, city level, and special jurisdiction level.
    * * In Canada, this value can be used for rules written at the `Country` or `State` jurisdictional levels. If set to `true`, this rule will apply at all lower jurisdictional levels.
    *  
    ...
    * this indicates the unit of measurement type used to calculate the amounts for this rule.
    ...
    /**
     * Returns a JSON string representation of CustomRuleGeneratedTaxRuleModel
     */
    @Override
