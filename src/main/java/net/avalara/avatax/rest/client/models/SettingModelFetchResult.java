 ...
 * 
 */
public class SettingModelFetchResult {
    ...
    private ArrayList<SettingModel> value;
     ...
     * 
     */
    public ArrayList<SettingModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<SettingModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of SettingModelFetchResult
     */
    @Override
