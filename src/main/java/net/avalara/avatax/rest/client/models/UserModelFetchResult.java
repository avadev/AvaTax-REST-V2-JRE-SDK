 ...
 * 
 */
public class UserModelFetchResult {
    ...
    private ArrayList<UserModel> value;
     ...
     * 
     */
    public ArrayList<UserModel> getValue() {
        return this.value;
    }
     ...
     * 
     */
    public void setValue(ArrayList<UserModel> value) {
        this.value = value;
    }
    ...
    /**
     * Returns a JSON string representation of UserModelFetchResult
     */
    @Override
